...
# 2. Chọn Mode để thử (Anghiệm ( ECB, CBC, CTR...)
mode = AES.MODE_CFB
cipher = AES.new(key, mode, iv, segment_size=128) #segment_size=128 bit=16 bytes
...
cipher_dec = AES.new(key, mode,iv, segment_size=128)
